...
letters = "quvdnxbhzysacefgijklmoprtw"
two_letter_combos = [''.join(combo) for combo in product(letters, repeat=3)]

csv_file = "avail_three_letters.csv"
...
if __name__ == "__main__":
    ...
    for batch, lst in enumerate(split_list(two_letter_combos, 100)):
        process_combos(lst, batch)
